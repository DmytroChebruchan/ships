...
def check_for_speed(form):
    required_fields = ['name', 'speed_in_kn',
                       'consumption_main', 'consumption_additional']
...
def add_ship(request):
    ...
    return render(request, 'add_ship.html', {'ship_form': ship_form,
                                             'speed_formset': speed_formset})
